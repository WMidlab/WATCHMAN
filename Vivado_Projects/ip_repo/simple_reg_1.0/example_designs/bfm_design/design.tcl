proc create_ipi_design { offsetfile design_name } {
	...
	set simple_reg_0 [ create_bd_cell -type ip -vlnv user.org:user:simple_reg:1.0 simple_reg_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:simple_reg:1.0]]]]
