...
set script_file "CreateProjectVivadoV2.tcl"
...
set files [list \
 ...
 [file normalize "${origin_dir}/hw/src/98_Basic_Component/afifo.vhdl"]\
 ...
 [file normalize "${origin_dir}/hw/src/AXI_Stream_Interface/AXI_STREAM_INTERFACE.vhdl"]\
 ...
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/TARGETC_TOPLEVEL.vhd"]\
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/99_Packages/Register_pkg.vhd"]\
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/99_Packages/AXI_Lite_pkg.vhd"]\
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/99_Packages/TARGETC_pkg.vhd"]\
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/Digitization_Readout/DIGITIZATION_READOUT.vhd"]\
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/Register_Handler/REGISTER_HANDLER.vhd"]\
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/Clock_Management/CLOCK_MANAGEMENT.vhd"]\
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/Round_Buffer/WINDOW_DISPATCH.vhd"]\
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/Round_Buffer/CPU_CONTROLLER.vhd"]\
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/Round_Buffer/ROUND_BUFFER.vhd"]\
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/Round_Buffer/TRIGGER_CONTROLLER.vhd"]\
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/Round_Buffer/SingleTrigger.vhd"]\
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/Round_Buffer/LookupTable_LE.vhd"]\
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/Round_Buffer/Window_Brain.vhd"]\
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/Round_Buffer/BlockDelay.vhd"]\
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/Round_Buffer/BitSelector.vhd"]\
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/Round_Buffer/HammingDecoder.vhd"]\
 [file normalize "${origin_dir}/hw/src/TargetC_Interface/TargetC_Control/TARGETC_Control.vhd"]\
] 
