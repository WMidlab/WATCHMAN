...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins TARGETC_0/TC_AXI]
	connect_bd_net [get_bd_pins TARGETC_0/tc_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins TARGETC_0/tc_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_TARGETC_0_TC_AXI_* ]]
	puts $fp "set tc_axi_addr ${offset}"
