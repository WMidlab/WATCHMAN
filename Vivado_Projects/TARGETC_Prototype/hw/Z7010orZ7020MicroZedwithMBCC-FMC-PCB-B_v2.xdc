...
set_property PACKAGE_PIN M19 [get_ports {WL_CLK_P[0]}]
set_property PACKAGE_PIN M20 [get_ports {WL_CLK_N[0]}]
...
set_property IOSTANDARD LVDS_25 [get_ports {HSCLK_P[0]}]
set_property IOSTANDARD LVDS_25 [get_ports {HSCLK_N[0]}]
set_property PACKAGE_PIN K14 [get_ports {HSCLK_P[0]}]
set_property PACKAGE_PIN J14 [get_ports {HSCLK_N[0]}]
