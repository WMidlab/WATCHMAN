...
set files [list \
 [file normalize "${origin_dir}/hw/src/iobuf.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGETC_Stream/axistream_V3.vhdl"] \
 [file normalize "${origin_dir}/hw/src/TARGETC_FIFOManager/AddressDecoder.vhdl"] \
 [file normalize "${origin_dir}/hw/src/TARGETC_FIFOManager/DataDecoder.vhdl"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/TARGETC_pkg.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGETC_FIFOManager/fifo.vhdl"] \
 [file normalize "${origin_dir}/hw/src/TARGETC_FIFOManager/fifoManager_V4.vhdl"] \
 [file normalize "${origin_dir}/hw/user_ip/TARGETC_IP_Interface/src/AXI_Lite_pkg.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/RDAD_WL_SMPL.vhd"] \
 [file normalize "${origin_dir}/hw/user_ip/TARGETC_IP_Interface/src/Register_pkg.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/RoundBufferGray500MHz.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/TARGETC_ClockManagementV3.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/TARGETC_Control.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/TARGETX_DAC_CONTROL.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/afifo.vhdl"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/counter.vhdl"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/TARGETC_TOPLEVEL.vhd"] \
 [file normalize "${origin_dir}/hw/bd/base_zynq/base_zynq.bd"] \
 [file normalize "${origin_dir}/hw/bd/base_zynq/hdl/base_zynq_wrapper.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/TARGETC_ClockManagementV2.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/WindowBuffer/WindowCPU.vhd"] \
 [file normalize "${origin_dir}/hw/sim/WindowCPU/TB_WindowCPU.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/WindowBuffer/WindowCPU_pkg.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/WindowBuffer/WindowSelect.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/WindowBuffer/WindowStore.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/WindowBuffer/WindowControl.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/WindowBuffer/MUX256x8.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/WindowBuffer/Comparator.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/WindowBuffer/LEComparator.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/WindowBuffer/TEComparator.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/WindowBuffer/TriggerCell.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/WindowBuffer/LookupTable_LE.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/WindowBuffer/LookupTable_TE.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/WindowBuffer/WindowTriggerl.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/WindowBuffer/TriggerCPU.vhd"] \
 [file normalize "${origin_dir}/hw/src/TARGET_Interface/WindowBuffer/RundBufferElement.vhd"] \
]
...
set file "[file normalize "$origin_dir/hw/Test_TARGETC.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/hw/Test_TARGETC.xdc"
set file [file normalize $file]
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/hw/Test_TARGETC.xdc"]" -objects $obj
set_property -name "target_part" -value "xc7z010clg400-1" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/hw/Test_TARGETC.xdc"]" -objects $obj
