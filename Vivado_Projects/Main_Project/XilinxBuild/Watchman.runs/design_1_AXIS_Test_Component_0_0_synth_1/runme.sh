...
HD_PWD='/home/idlab-52/Desktop/GitVivado/Ky/WATCHMAN/Vivado_Projects/Main_Project/XilinxBuild/Watchman.runs/design_1_AXIS_Test_Component_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AXIS_Test_Component_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AXIS_Test_Component_0_0.tcl
