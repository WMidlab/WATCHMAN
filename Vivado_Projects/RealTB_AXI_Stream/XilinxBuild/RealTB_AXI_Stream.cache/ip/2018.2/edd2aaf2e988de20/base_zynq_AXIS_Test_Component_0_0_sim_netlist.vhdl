...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXIS_Peripheral_v1_0_S00_AXI is
  port (
    ...
    \FSM_onehot_mst_exec_state_reg[0]_0\ : in STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXIS_Peripheral_v1_0_S00_AXI is
  ...
  signal \FSM_onehot_mst_exec_state[1]_i_11_n_0\ : STD_LOGIC;
...
\FSM_onehot_mst_exec_state[0]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000020AAAAAAAA"
        ...
        port map (
      I0 => \FSM_onehot_mst_exec_state_reg[0]_0\(0),
...
\FSM_onehot_mst_exec_state[1]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\FSM_onehot_mst_exec_state[1]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
AXIS_Peripheral_v1_0_S00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXIS_Peripheral_v1_0_S00_AXI
     port map (
      ...
      \FSM_onehot_mst_exec_state_reg[0]_0\(0) => AXIS_Peripheral_v1_0_M00_AXIS_inst_n_0,
