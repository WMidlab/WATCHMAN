...
synth_design -top base_zynq_processing_system7_0_0 -part xc7z010clg400-1 -mode out_of_context
...
set TIME_taken [expr [clock seconds] - $TIME_start]
 ...
 config_ip_cache -add -dcp base_zynq_processing_system7_0_0.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips base_zynq_processing_system7_0_0]
}
