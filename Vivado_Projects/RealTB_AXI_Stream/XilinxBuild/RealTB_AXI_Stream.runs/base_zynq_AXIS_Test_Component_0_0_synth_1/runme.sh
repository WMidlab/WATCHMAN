...
HD_PWD='/home/jonathan/GitProjects/WATCHMAN/Vivado_Projects/RealTB_AXI_Stream/XilinxBuild/RealTB_AXI_Stream.runs/base_zynq_AXIS_Test_Component_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_zynq_AXIS_Test_Component_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_zynq_AXIS_Test_Component_0_0.tcl
