...
HD_PWD='/home/idlab-52/Desktop/GitVivado/WATCHMAN/Vivado_Projects/UDP/prototype_watchman.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log prototype_watchman_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source prototype_watchman_wrapper.tcl -notrace
