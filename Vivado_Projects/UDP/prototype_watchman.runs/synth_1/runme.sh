...
HD_PWD='/home/idlab-52/Desktop/GitVivado/WATCHMAN/Vivado_Projects/UDP/prototype_watchman.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prototype_watchman_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prototype_watchman_wrapper.tcl
